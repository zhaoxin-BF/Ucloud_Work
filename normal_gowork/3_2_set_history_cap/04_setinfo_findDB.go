...
//	fmt.Println("处理数据")
//	for i:=0; i<10; i++ {
//		setcaphistoryinfo := SetCapHistroyInfo{"hn02", "广州二B", 1101, "hn02_1101", "ssd_data", 1583219330, "国内", "国内ssd_data", 1024, 512, 800, 512, 20.24, 120, 220}
...
func main() {
	...
	err = c.Find(bson.M{"set_usage": "ssd_data"}).All(&setinfos)
	...
	for key, oneregionset := range allregionsetinfo{
		fmt.Println(key,oneregionset)
	}
}